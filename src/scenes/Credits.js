class Credits extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.image(game.config.width*3/4, game.config.height*1/6, 'sSheet', 'bikeWheeled').setOrigin(.5).setScale(4).setAngle(-20)

        //text
        //title
        this.add.bitmapText(game.config.width*2/5, game.config.height*1/6, 'pixelU', 'CREDITS', 64).setOrigin(.5)
